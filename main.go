...
func main() {
	buf, err := parser.ParserV3.EncodePayload([]*packet.Packet{
		&packet.Packet{
			Type: "ping",
			Data: types.NewStringBuffer([]byte(`😀😁😀😁😀你好呀, 2, 3, 4, 5,😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁wn5iB`)),
		},
		&packet.Packet{
			Type: "ping",
			Data: types.NewStringBuffer([]byte(`😀😁😀😁😀你好呀, 2, 3, 4, 5,😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁😀😁wn5iB😀😁`)),
		...
		&packet.Packet{
			Type: "noop",
			Data: types.NewBytesBufferString(`[]by:te{0, 1你好呀, 2, 3, 4, 5, 6, 7, 8, 9}b2W11ieXRlezAsIDHkvaDlpb3lkYAsIDIsIDMsIDQsIDUsIDYsIDcsIDgsIDl9wn5iB`),
		},
	})
	fmt.Println(err)
	fmt.Println(buf.String())
	x := parser.ParserV3.DecodePayload(buf)
	fmt.Println(x)
	bufs, errs := parser.ParserV3.EncodePayload(x)
	fmt.Println(errs)
	fmt.Println(parser.ParserV3.Protocol())
